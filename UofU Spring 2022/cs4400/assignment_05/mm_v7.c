...
void mm_free(void *ptr)
{
  ...
  else if (GET_SIZE((FTRP(newPtr) + sizeof(size_t))) == 0)
  {
    ...
    /* if (((pageList *)newPtrHead) -> prev == NULL) */
    /* { */
    /*   nextPage = ((pageList *)newPtrHead) -> next; */
    /*   ((pageList *)nextPage) -> prev = NULL; */
    /* } */
    
    /* else if (((pageList *)newPtrHead) -> next == NULL) */
    /* { */
    ...
    /*   ((pageList *)prevPage) -> next = nextPage; */
    /*   ((pageList *)nextPage) -> prev = prevPage; */
    /* } */
...
static void add_to_free_list(void * ptr)
{
  size_t indexPicker = GET_SIZE(HDRP(ptr)) / 16;
  
  if (indexPicker >= 2 && indexPicker <= 64)
  {
    if (freeBlocks[0] == NULL)
    {
  ...
  else if (indexPicker >= 65 && indexPicker <= 192)
  {
    
  }

  else if (indexPicker >= 193 && indexPicker <= 350)
  {
    
  }

  else if (indexPicker >= 351 && indexPicker <= 500)
  {
    
  }

  else if (indexPicker >= 501 && indexPicker <= 650)
  {
    
  }

  else if (indexPicker >= 651 && indexPicker <= 800)
  {
    
  }

  else if (indexPicker >= 801 && indexPicker <= 950)
  {
    
  }

  else if (indexPicker >= 951 && indexPicker <= 1100)
  {
    
  }

  else if (indexPicker >= 1101 && indexPicker <= 1250)
  {
    
  }

  else if (indexPicker >= 1251 && indexPicker <= 1400)
  {
